...
export default function QuoteQuestionnaire() {
  ...
  const calculatePriceBreakdown = () => {
    ...
    const brandingCost = formData.additionalServices.includes("branding")
      ? 1000
      : 0;
    ...
    const addProportionalItems = (
      items: Array<{ label: string; proportion: number }>,
    ) => {
      ...
      items.forEach((item, index) => {
        if (index === items.length - 1) {
          ...
          breakdown.push({
            item: item.label,
            price: Math.round(remainingPrice),
          });
        } else {
    ...
    if (formData.projectType === "static") {
      breakdown.push({
        item: "Professional static website with modern design",
        price: Math.round(baseProjectPrice),
      });
      ...
      addProportionalItems([
        ...
        {
          label: "Database integration (Supabase or similar)",
          proportion: 0.35,
        },
    ...
    if (brandingCost > 0) {
      breakdown.push({
        item: "Brand identity and design system (included above)",
        price: 0,
      });
    }
    ...
    if (formData.projectType !== "" && baseMonthlyPrice > 0) {
      breakdown.push({
        item: "Hosting, maintenance, and updates",
    ...
    if (formData.userTracking === "advanced") {
      ...
      breakdown.push({
        item: "User tracking monthly service",
        price: 50,
        isMonthly: true,
      });
    }
    ...
    if (formData.ctoServices) {
      breakdown.push({
        item: "Monthly fractional CTO services",
        price: 2000,
        isMonthly: true,
      });
    }
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex-1 pr-8">
                    <div className="font-semibold mb-1">Branding & Design</div>
                    <div className="text-sm text-muted-foreground">
            ...
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="bg-muted/30 rounded-lg p-6">
                ...
                <p className="text-muted-foreground mb-4">
                  This is a rough estimate based on your selections. Let's
                  schedule a call to discuss your project in detail and provide
              ...
              <div className="bg-muted/20 border border-muted rounded-lg p-6">
                ...
                <p className="text-sm text-muted-foreground">
                  ...
                  <strong>not a commitment or contract</strong> and are{" "}
                  <strong>just a rough estimate</strong> based on your answers.
                  Everything is <strong>subject to change</strong> based on a
                  detailed project discussion. For specific pricing and project
                  details, please contact <strong>Bryson</strong> directly.
                </p>
              </div>
