---
slug: blue-logic-water
title: Blue Logic Water
description: A lightning-fast, SEO-optimized website for a premium water filtration company, built with Astro and Cloudflare Pages delivering sub-1.2s load times and modern design aesthetics.
status: Active
...
- **60fps animations** - Smooth interactions respecting `prefers-reduced-motion`
- **Edge-first architecture** - Global CDN distribution via Cloudflare
...
- **Dynamic routes** - Bracket notation for city-specific pages (`[city].astro`)
- **Nested layouts** - Consistent structure with Layout.astro wrapper
