...
Next, **contact Wix support via live chat**. This is important—start with live chat, not email. Explain clearly: _"I want to change my nameservers to Cloudflare so that I can point my website to Cloudflare. Here are the exact nameservers I need changed."_ Be very explicit about what you need. The live agent will likely say they can help but that you need to follow up via email.
...
But don't worry. The change _is_ happening. You can verify it's working by using third-party DNS propagation tools online. You'll start to see the new Cloudflare nameservers show up gradually.
